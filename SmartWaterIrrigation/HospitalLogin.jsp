...
<style>
  body {
    background:linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url('images/36.jpg') no-repeat 0% 12% fixed;
...
<body class="layout-container ls-top-navbar si-l3-md-up">
  ...
  <nav class="navbar navbar-dark bg-primary navbar-full navbar-fixed-top">
   ...
   <a href="home.jsp" class="navbar-brand"><i class="material-icons"></i>Accident Prevention Using IOT</a>
    ...
    <ul class="nav navbar-nav pull-xs-right">
      ...
      <li class="nav-item dropdown">
        ...
        <a href="HospitalLogin.jsp"><font color="White">Hospital Login</font></a>
      </li>
    </ul>
    <!-- // END Menu -->
    ...
    <div class="container-fluid">
      ...
      <div class="card" style="width: 60%; margin-top:150px;margin-left:60px;border:2px solid white; background-color:transparent;">
            <div class="card-block">
              ...
              <form name="myform" action="HospitalLogin" onsubmit="return validateUser()" method="post">
