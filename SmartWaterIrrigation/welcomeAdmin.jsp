	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html"><h1>Personality Assessment</h1></a> </li>
				</ol>
				<!--four-grids here-->
		...
		<div class="menu">
			<ul id="menu">
				<li><a href="welcomeAdmin.jsp"><i class="fa fa-home"></i>
						<span>Home</span>
				<li><a href="addHR.jsp"><i class="fa fa-edit"></i>
						<span>Add HR</span>
		
				<li><a href="ViewHR.jsp"><i class="fa fa-edit"></i>
						<span>View HR</span>
