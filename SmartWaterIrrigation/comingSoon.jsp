	...
	<div id="wrapper">
		<nav class="navbar navbar-default navbar-cls-top " role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="home.jsp">Smart Water Irrigation System</a>
			</div>
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="comingSoon.jsp"><i class="fa fa-user"
							style="font-size: 20px; color: white"></i>Motor ON/OFF</a></li>
				
				<li><a href="viewCropSugg.jsp"><i class="fa fa-user"
							style="font-size: 20px; color: white"></i>View Crop Suggestion(sensor value)</a></li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-head-line">Coming Soon</h1>
