            ...
            <div class="card-block">
              ...
              <form name="myform" action="AdminLogin" onsubmit="return validateUser()" method="post">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-3 form-control-label" style="color:black;"><h4><b>Email</b></h4></label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-3 form-control-label" style="color:black;"><b>Password</b></label>
                  <div class="col-sm-9">
