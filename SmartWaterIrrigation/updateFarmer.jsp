	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-head-line">Update Farmer</h1><br><br>
						...
						<form action="UpdateFarmer" method="post">
                			...
                			<div class="form-group row">
                			<input type="hidden" name="action" value="add"/>
    						<label for="inputEmail3" class="col-sm-3 form-control-label">PH Value :</label>
                 		 	<div class="col-sm-9">
                    		<input type="numbers" cols="7" rows="1" class="form-control" name="phTxt" placeholder="Enter PH Value" onkeypress="return isNumberKey(event)" minlength="1" maxlength="5" required></input>
                  			</div>
                			</div>
