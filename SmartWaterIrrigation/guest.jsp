    ...
    <div class="container-fluid">
      ...
      <div class="card" style="width: 60%; margin-top:150px;margin-left:60px;border:1px solid white; background-color:transparent;">
            <div class="card-block">
            	...
            	<h1 class="sub-head" style="width: 60%; margin-left:60px; background-color:transparent;">Guest Login</h1>
             
              <form name="myform" action="LoginGuest" onsubmit="return validateUser()" method="post">
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-3 form-control-label" style="color:black;"><h2><b>Enter current city</b></h2></label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row m-b-0">
                  <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-primary" style="margin-right:100px;">weather & Crop suggestion</button>
                  </div>
                </div>
